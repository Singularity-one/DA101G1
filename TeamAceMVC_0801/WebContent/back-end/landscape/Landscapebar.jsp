	...
	<div class="logo" style="margin-right: 30px;">
		...
		<ul class="list-group list-group-flush"
			...
			<li class="list-group-item"><a style="text-decoration:none; color:black"
				href='<%=request.getContextPath()%>/back-end/landscape/select_page.jsp'>查詢景點</a></li>
			<li class="list-group-item"><a style="text-decoration:none; color:black"
				href='<%=request.getContextPath()%>/back-end/landscape/landscape.jsp'>全部景點</a></li>
			<li class="list-group-item"><a style="text-decoration:none; color:black"
				href='<%=request.getContextPath()%>/back-end/landscape/addLandscape.jsp'>新增景點</a></li>
			<li class="list-group-item"><a style="text-decoration:none; color:black"
