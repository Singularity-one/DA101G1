...
<body>
	...
	<form name="login-form" class="login-form" action="<%=request.getContextPath()%>/back-end/AdminLogin.do" method="post">

		<div class="header">
			<h1>Master Administrator</h1>
			<span>偉大的管理員您好，請輸入您的密碼</span>
		</div>

		<div class="content">
			<input name="administrator_no" type="text" class="input username" placeholder="Administrator No" />
			<div class="user-icon"></div>
			<input name="administrator_psw" type="password" class="input password" placeholder="Password" />
			<div class="pass-icon"></div>
		</div>

		<div class="footer">
<%-- 			<a href="<%=request.getContextPath()%>/front-end/register.jsp"	class="button2">註冊</a>  --%>
