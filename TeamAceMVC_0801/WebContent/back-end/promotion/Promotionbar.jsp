...
<body>
	<div class="logo" style="margin-right: 30px;">
		...
		<ul class="list-group list-group-flush "
			...
			<li class="list-group-item"><a style="text-decoration:none; color:black"style="text-decoration:none; color:black"
				href='<%=request.getContextPath()%>/back-end/promotion/portal.jsp'>查詢廣告</a></li>
			<li class="list-group-item"><a style="text-decoration:none; color:black"
				href='<%=request.getContextPath()%>/back-end/promotion/Promotion.jsp'>全部廣告</a></li>
			<li class="list-group-item"><a style="text-decoration:none; color:black"
