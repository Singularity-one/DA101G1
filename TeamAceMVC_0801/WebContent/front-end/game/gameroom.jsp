...
<!-- 					alt="" ><br>	 -->
								...
								<div class="cp-unit cp-unit--l" >
                                    <div class="category ">
                                        <img src="image/civ.png" style="display:none">
                                    </div>
                                    ...
                                    <p>
                                        <span class="t-container">
                                            <span id="GameName1">IIIMisJ</span>
                                        </span>
                                    </p>
                                    </div>
                                </a>
...
<!-- 					alt=""><br>	 -->
							<div class="cp-unit cp-unit--l" >
                                    ...
                                    <p>
                                        <span class="t-container">
                                            <span id="GameName4">IIIMisJ</span>
                                        </span>
                                    </p>
                                    </div>
                                </a>
...
<!-- 				<span id="GameName4"></span> -->
		...
		<div class="row align-items-center">
			...
			<div class="col">
				 <img src="<%=request.getContextPath()%>/front-end/game/image/sun.jpg"  style="display:none" id="sun">
				<h1>GAME Room</h1>
