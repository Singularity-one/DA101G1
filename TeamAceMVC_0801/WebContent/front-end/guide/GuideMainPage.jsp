		...
		<div class="row justify-content-center content">
			...
			<div class="col-6 right">
				...
				<c:if test="${not empty guideVO.guide_stLang}">
					<span style="background-color:#FF8C00;padding:6px; border-radius:4px 4px 4px 4px;color:#fff;font-size:14px">
				...
				<p style="padding-top: 20px;line-height:36px;letter-spacing:2px;">&nbsp&nbsp&nbsp
					${guideVO.guide_hobby}
				</p>
