...
<!-- 		      <form action="MemberLogout.do" id="myForm" method="get"	enctype="multipart/form-data"> -->
<!-- 		      <input type="submit">登出 -->
<%-- 		      <button class="btn btn-outline-success my-2 my-sm-0" onclick="logoutbtns()"><b id="isLogout" name="${ memberVO.mem_name}" >登出</b></button> --%>
<!-- 		      </form> -->
		    </div>
		  </div>
	</nav>
		  ...
		  <div class="carousel-inner">
		    <div class="carousel-item active">
		      <img src="https://picsum.photos/1200/300?random=1" class="d-block w-100" id="test1">
		    </div>
		    <div class="carousel-item">
		      <img src="https://picsum.photos/1200/300?random=2" class="d-block w-100" id="test2">
		    </div>
		    <div class="carousel-item">
		      <img src="https://picsum.photos/1200/300?random=3" class="d-block w-100" id="test3">
		    </div>
		  </div>
			...
			<div class="contents-container" id="js-contents" style="padding-left: 200px">
                ...
                <div class="contents-list is-h-auto" id="sortmenu">
                	<div id="tstory" style="visibility:hidden" >
						<video src="" autoplay="" id="ttstory" width="300px" 
							height="300px"  onclick="nextt()" ></video>
...
// 		 						$('#itineraryBody').append(item.landscape_no);
		 						...
		 						if(item.question!=null){
		 							...
		 							$('#condition').next().html("<b>回答問題:</b>"+item.question+"<br>"+
		 									"<b>到指定地點定位</b>")
		 						}
		 					});
					     },
