...
<!-- 					<input type="file"name="pic"><br><br> -->
					...
					<br>
					 <b>自訂問題</b>&nbsp <input  name="qustion" value=""><br><br>
					 <b>選項1:</b><input  id="qustionOption1"  name="qustionOption" value=""> <input type="checkbox" name="checkboxes"  class="checkboxGroup" value="1"><span></span><br><br>
					 <b>選項2:</b><input  id="qustionOption2"  name="qustionOption" value=""> <input type="checkbox" name="checkboxes"  class="checkboxGroup" value="2"><span></span><br><br>
					 <b>選項3:</b><input  id="qustionOption3"  name="qustionOption" value=""> <input type="checkbox" name="checkboxes"  class="checkboxGroup" value="3"><span></span><br><br>
					 <b>城市:</b> 
...
// 										console.log(!mapCity.values().next().value[0].includes(arrName[0]));
					  				    uploadmap(arrLat[arrLat.length - 1],arrLng[arrLng.length - 1]);
					  		} else{
					  			alert(xhr.status);
					  			alert("AJAX發生錯誤囉!");
					  		}
...
// 		}
			...
			function initialize() {
		      ...
		      //
		      function uploadmap(selectLat,selectLng){
