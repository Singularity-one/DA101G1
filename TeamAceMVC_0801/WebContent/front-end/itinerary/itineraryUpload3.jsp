					...
					<br>
					 ...
					 <b>城市:</b> 
						...
						<input type="file" name="pic" onchange="readURL(this)"
							...
							<br> 
						<input type="file" name="pic" class="file_multi_video upload_cover" accept="video/*">
<!-- 						<input type="file" name="pic"><br> -->
				...
				<div id='prev'>
					...
					<video autoplay muted class="video_show displayNone"  width="200px" height="300px">
...
<%-- 									${(landscape_city==landscape_city)? 'selected':'' }>${landscape_city} --%>
					...
					<input id="pic"  type="file" name="pic" onchange="readURL(this)"
							...
							accept="image/gif, image/jpeg, image/png"> <br>							
					<input type="file" name="pic" class="file_multi_video2 upload_cover" accept="video/*"  >
				 </div>
...
// 		    	  	console.log(arrCity);
		      ...
		      function readVideo(id){
		    	  ...
		    	  $('.video_show2').show();
		    	  $source[0].src = URL.createObjectURL($('#video_here2').files[0]);
				  $source.parent()[0].load();
		      }
