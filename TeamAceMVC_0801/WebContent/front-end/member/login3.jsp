...
<body>
	...
	<form name="login-form" class="login-form" action="MemberLogin.do" method="post">
		...
		<div class="header">
			...
			<span>親愛的會員您好，請輸入您的密碼</span>
		</div>

		<div class="content">
			<input name="mem_email" type="text" class="input username" placeholder="Email" />
			<div class="user-icon"></div>
			<input name="mem_psw" type="password" class="input password" placeholder="Password" />
