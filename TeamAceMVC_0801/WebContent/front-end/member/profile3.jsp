	...
	<div class="outer">
		...
		<div class="row justify-content-center content">
			...
			<div class="btngroup col-7 container">
				...
				<div class="col-2" id="brightness">
					<img src="images/heart.png" class="btnimg"  onclick="track()">
				</div>
...
<%-- 				</c:forEach> --%>
								...
								<c:forEach var="itineraryStartVO" items="${itineraryStartSvc.getItineraryStartByMemNo(param.mem_no)}">
									<sapn class="itinerarySelect"  onclick="itineraryQuestionShow('${itineraryStartVO.itinerary_no}')">
										<c:forEach var="itinerary_detailVO" items='${itinerary_detailSvc.getLands(itineraryStartVO.itinerary_no)}' varStatus="s">      
											<div class="">
								 			  <div class="itstatus"><b class="Starting">進行中</b></div>&nbsp&nbsp 	${ landscapeSvc.getOneLas(itinerary_detailVO.getLandscape_no()).landscape_name}	
            ...
            <div class="row" style="border:1px solid #e0e0e0;margin:10px;padding:5px;width:610px;height:140px;box-shadow:2px 2px 2px 2px #cccccc;">
                    <div class="col-md-4">
                    ...
                    <div style="margin-left:380px;position: absolute;margin-top: 90px;">
                    
                    <form method="post" action="Itinerary_trackServlet" style="margin-bottom: 0px;">
<!-- 					 動態星星 -->
					<span class="ratings">
					  ...
					  <a href="#" title="5/5"><i class="rate fa fa-star"></i></a>
                        ...
                        <input type="hidden" name="itinerary_no" value="${itinerary_detailVO.itinerary_no}">
                        <input type="hidden" name="mem_no" value="${param.mem_no}">
                        <input type="hidden" name="action" value="deleteFromItinerary_track">
					</form>
