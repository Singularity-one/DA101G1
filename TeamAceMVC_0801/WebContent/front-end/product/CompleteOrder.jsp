...
<%
     Order_detailVO orderno = (Order_detailVO) request.getAttribute("orderno");
      String ordernumber = orderno.getOrder_no();
%>
	...
	<div class="container justify-content-center">
		<div class="card" style="width: 35rem;">
			<div class="card-body adjust">
				<div>
					<h5 class="card-title">Good&nbspJob!&nbsp訂單已成立!</h5>
				</div>
				<div>
					<h6 class="card-subtitle mb-2 text-muted">&middot;&nbsp訂單編號&nbsp<%=ordernumber%></h6>
					<p class="card-text">&middot;&nbsp點擊商城首頁會員圖像可查訪訂單詳情</p>
					<p class="card-text">&middot;&nbsp如欲取消訂單，請在收到出貨通知前，至訂單詳情點擊申請取消</p>
					<p class="card-text">&middot;&nbsp退換貨請參考商城首頁退換貨政策</p>
				</div>
				<div>
