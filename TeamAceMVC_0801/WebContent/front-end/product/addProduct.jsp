...
<table>
	...
	<tr>
		...
		<td><input type="TEXT" name="product_name" size="45"
			 value="<%= (productVO==null)? "香蕉" : productVO.getProduct_name()%>" id="test1"/></td>
	</tr>
	<tr>
		<td>商品狀態:</td>
		<td><%="上架"%></td>
	...
	<tr>
		...
		<td><input type="TEXT" name="product_pr" size="45"
			 value="<%= (productVO==null)? "100" : productVO.getProduct_pr()%>" id="test2"/></td>
	</tr>
	<tr>
		<td>商品種類:</td>
		<td><input type="TEXT" name="product_typ" size="45"
			 value="<%= (productVO==null)? "農產品" : productVO.getProduct_typ()%>" id="test3"/></td>
	</tr>
	<tr>
		<td>廣告促銷狀態:</td>
		<td><%="沒有廣告促銷狀態"%></td>
...
<%-- 			 value="<%= (productVO==null)? "666666" : productVO.getProduct_ps()%>" /></td> --%>
		<td><textarea  name="product_ps" style="width:400px;height:120px;" id="test4"></textarea></td>
	</tr>
	<tr>
		<td>商品圖片:</td>
		<td>
