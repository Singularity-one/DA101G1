...
public class Itinerary_trackServlet0728 extends HttpServlet {
...
//				failureView.forward(req, res);
		...
		if ("deleteFromItinerary_track".equals(action)) {
			try {
				...
				String url = "/front-end/listAllItinerary_track.jsp";
				RequestDispatcher successView = req.getRequestDispatcher(url);
				successView.forward(req, res);
			} catch (Exception e) {
				RequestDispatcher failureView = req.getRequestDispatcher("/front-end/listAllItinerary_track.jsp");
				failureView.forward(req, res);
			}
		}
	}
